...
namespace Microsoft.Bot.Builder.Azure.Tests
{
    ...
    public class TableStorageTests : StorageBaseTests
    {
        ...
        public void TestInit()
        {
            ...
            {
                stateStore = new AzureTableStorageStateStore("UseDevelopmentStorage=true", TestContext.TestName.Replace("_","") + TestContext.GetHashCode().ToString("x"));
            }
        }
        ...
        public async Task TableStorage_TestCleanUp()
        {
            if (stateStore != null)
            {
                AzureTableStorageStateStore store = (AzureTableStorageStateStore)stateStore;
